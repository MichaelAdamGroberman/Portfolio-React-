...
import { ProfileImage } from './aboutElements'
...
const About = (props) => {
    ...
    return (
        <Sectioncontainer id="About">
            ...
            <SectionContent>
                <ProfileImage background={profile} />
                <SectionText>
                    ...
                    I am passionate in overall development with a focus on successful execution possessing a broad technical skill set across all dimensions and integrations of information technology; including design, architecture, implementations, budgeting, vendor selection, optimization, management, and support.<br /><br />
                    I'm currently enrolled in the Full-Stack Developer Bootcamp at Columbia Engineering, and am excited to expand on my skillset and knowledge.</SectionText></SectionContent>
        </Sectioncontainer>
    )
}
